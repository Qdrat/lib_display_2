                         ...
                         bool is_common_cathode)
{
    ...
    if (!table)
    {
        table = is_common_cathode ? &DEFAULT_TABLE_CC_STRUCT : &DEFAULT_TABLE_CA_STRUCT;
    }
...
SegmentChar segchar_from_ascii(char ascii_char)
{
    ...
    case '.':
        return SEG_CHAR_DOT;
    case ',':
        return SEG_CHAR_COMMA;
    case ':':
        return SEG_CHAR_COLON;
    case ';':
        return SEG_CHAR_SEMICOLON;
    case '!':
    ...
    case '{':
        return SEG_CHAR_LBRACE;
    case '}':
        return SEG_CHAR_RBRACE;
    case '<':
        return SEG_CHAR_LT;
    case '>':
        return SEG_CHAR_GT;
    case '@':
        return SEG_CHAR_AT;
    case '#':
        return SEG_CHAR_HASH;
    case '$':
        return SEG_CHAR_DOLLAR;
    case '%':
